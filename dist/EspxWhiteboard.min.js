var EspxWhiteboard = (function (clappr,deepstream) {
	...
	// TODO:
	/*
	0. Use 'hammer.js, for both touchevent and mouse event handling
		==> others: Easel.js, create.js, tracking.js, konva.js

	1. Snapshot current frame of video -- make drawing over it and save as a list of images
		User clicks on image to go back to that point in time of video (paused) with overlay of annotation

	2. Live Video Annotation with time encoding
		http://html5doctor.com/video-canvas-magic/
		Grab the pixels from video.. put it on backing canvas.. modify pixels/ annotate /doodle over that canvas or  overlay a different canvas

	3. Make a sliding window thing over an array of short lines that are time encoded ...keep only,say, 10 short lines in my drawing array[window] 
	NOTE:: original idea -- We need json like lightweight file that overlays video with annotations

	4. remove last continuously drawn points if mouseUp happened for 2 sec or something 
	...
	*/
	...
	class EspxWhiteboard extends clappr.UICorePlugin {
		...
		onTimeUpdate(progress) {
			...
			//console.log(this.curMedContTime);
		}
		...
		onReplay(progress) {
			...
			//EXP 1. //while(this.rPos<this.points.length && Math.floor(progress.current) === Math.floor(this.points[this.rPos].timeEl) ){
		...
		render() {
			// This is the Whiteboard button UI Object that has to be put onto player
